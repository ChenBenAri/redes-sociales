...
describe('template spec', () => {
  it('passes', () => {
    cy.request('GET', 'http://192.168.0.108:5000').then((response) => {
      ...
      cy.wait(longTime)  
      cy.get('span[class^="x1lliihq x1plvlek xryxfnj"]:contains("Mute")').click()
      cy.get('span[class^="x1lliihq x193iq5w x6ikm8r x10wlt62 xlyipyv xuxw1ft"]:contains("Stories")').click()
      cy.get('div[class^="x1i10hfl"]:contains("Save")').click()
